...
#define INTERNAL_ALLOC_NO_NODES \
  ((INTERNAL_ALLOC_CHUNK_SIZE_BYTES / INTERNAL_ALLOC_LEAST_REGION_SIZE_BYTES) - 1)
#define INTERNAL_ALLOC_BUDDY_TREE_SIZE_BITS (INTERNAL_ALLOC_NO_NODES * 2)
#define INTERNAL_ALLOC_BUDDY_TREE_SIZE_BYTES (INTERNAL_ALLOC_BUDDY_TREE_SIZE_BITS + 7) & ~7
