...
SIZE_CLASS_SMALL = [
    x
    for x in range(MIN_SIZE_CLASS_SMALL, MAX_SIZE_CLASS_SMALL + 1, MIN_SIZE_CLASS_SMALL)
]
...
def main():
    ...
    gen_header = env.get_template("generator.j2").render(
        sc_small_gen=sc_small_gen,
        sc_medium_gen=sc_medium_gen,
        max_gens_small=max_gens_small,
        max_gens_medium=max_gens_medium,
    )
